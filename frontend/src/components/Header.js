        ...
        return (
            <div className="nav-header bg-white shadow-xs border-0">
                <div className="nav-top">
                    ...
                    <Link to="/chat" className="mob-menu ms-auto me-2 chat-active-btn"><i className="feather-message-circle text-grey-900 font-sm btn-round-md bg-greylight"></i></Link>
                        ...
                        <div className="nav-content">
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                                ...
                                <ul className="mb-1 top-content">
                                    ...
                                    <li onMouseEnter={() => this.setState({showSubmenu: "newsfeed"})}>
                                        <Link className="nav-content-bttn open-font">
                                    ...
                                    <li onMouseEnter={() => this.setState({showSubmenu: "badges"})}>
