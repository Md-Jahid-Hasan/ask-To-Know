...
class Header extends Component {
    ...
    state = {
        isOpen: false,
        isActive: false,
        isNoti: false, showSubmenu: false
    };
        ...
        return (
            <div className="nav-header bg-white shadow-xs border-0">
                <div className="nav-top">
                    ...
                    <Link to="/chat" className="mob-menu ms-auto me-2 chat-active-btn"><i
                ...
                <Link to="/chat" className="p-2 text-center ms-3 menu-icon chat-active-btn"><i
                        ...
                        <div className="nav-content">
                            <div
                                ...
                                <ul className="mb-1 top-content">
                                    ...
                                    <li onClick={() => this.setState({showSubmenu: "newsfeed"})}>
                                        <Link className="nav-content-bttn open-font" to={"/"}>
                                            <i className="feather-tv btn-round-md bg-blue-gradiant me-3"></i>
                                            <span>Newsfeed</span>
                                        </Link>
                                        <ul className={`ms-5 ps-4 fade-transition ${this.state.showSubmenu === "newsfeed" ? "d-block show" : "d-none"}`}>
                                            <li>
                                                <Link to="/latest-news" className="nav-content-bttn open-font">
                                                    Latest News</Link>
                                            </li>
                                            <li><Link to="/trending"
                                                      className="nav-content-bttn open-font">Trending</Link></li>
                                        </ul>
                                    </li>

                                    <li onClick={() => this.setState({showSubmenu: "badges"})}>
                                        <Link to="/defaultbadge" className="nav-content-bttn open-font">
                                            <i className="feather-award btn-round-md bg-red-gradiant me-3"></i>
                                            <span>Badges</span>
                                        </Link>

                                        <ul className={`ms-5 ps-4 fade-transition ${this.state.showSubmenu === "badges" ? "d-block show" : "d-none"}`}>
                                            <li><Link to="/latest-news" className="nav-content-bttn open-font">Latest
                                                News</Link></li>
                                            <li><Link to="/trending"
                                                      className="nav-content-bttn open-font">Trending</Link></li>
                                        </ul>
