                                    ...
                                    <div
                                        ...
                                        <div className="chat-wrapper pt-0 w-100 position-relative scroll-bar">
                                            <div className="chat-body p-lg-4 p-3 mt-lg-3 mt-0">
                                                ...
                                                <div className="accodion-style--1 accordion" preExpanded={'0'}>
                                                    <div className="shadow-none mb-0 p-0 bg-transparent">
                                                        {/*<div className="card-header ps-0 pt-0 pb-2 pe-0 bg-transparent">*/}
                                                        ...
                                                        {/*</div>*/}
                                                        <div className="card-body p-0">
                                                            <p class="text-grey-600 mb-4 font-xsss lh-28 fw-500 mt-3 text-dark">Hi
                                                                Aenni, <br/> <br/> All individual Framer subscriptions
                                                                have been grandfathered into a Pro plan at your existing
                                                                rate. If you were on a Small Team plan, then all 5 seats
                                                                have been converted over to Pro seats at your existing
